...
- **只报重要的**: 只报告中等及以上级别, 低微级别和代码质量问题不发送到 Discord
- **合理使用 Agent**: 智能合约项目使用 `contract-scanner` / `smart-contract-vuln` 等 Agent 辅助审计, 非合约项目由自身审计能力完成
...
- **全中文**: 报告和分析全部使用中文, 严重程度等级也使用中文, 禁止混入英文
